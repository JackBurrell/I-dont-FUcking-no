...
#        try {
#            wall = Class.forName("com.techelevator.Wall");                                                                                  NO IDEA HOW TO DO THIS
...
#        assertTrue("Wall should be an abstract class", Modifier.isAbstract(wall.getModifiers()));                                            NO IDEA HOW TO DO THIS
#    }
#
#    @Test
